...
public class EncoderConstant {
    ...
    public static final  int            MAX_VIDEO_INPUT_QUEUE_SIZE =    40;
    public static final  int            MAX_AUDIO_INPUT_QUEUE_SIZE =    400;
    ...
    public static final int             MUX_REORDER_PKT_SIZE       		= MAX_OUT_PUT_QUEUE_SIZE / 2;
